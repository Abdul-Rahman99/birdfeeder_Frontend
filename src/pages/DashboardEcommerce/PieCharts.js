...
const SimpleDonut = ({ dataColors, myData }) => {
    ...
    var options = {
        ...
        // labels: myData ? myData.labels : ["Loading"],
        labels: myData ? myData.labels : [],
        legend: {
            show: true,
            position: 'left'
        },
...
const SimpleDonutSchedules = ({ dataColors, myData }) => {
    var chartDonutBasicColors = getChartColorsArray(dataColors);
    const series = [myData?.fixed || 0, myData?.sunrise || 0, myData?.sunset || 0]
    var options = {
        chart: {
            height: 300,
            type: 'donut',
...
export { SimplePie, SimpleDonut, UpdateDonut, MonochromePie, GradientDonut, PatternedDonut }