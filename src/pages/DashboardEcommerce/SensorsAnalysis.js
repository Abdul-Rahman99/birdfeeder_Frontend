...
import { StepLineChart } from "./ECharts";
import { Icon } from "@iconify/react";
    ...
    socket.on("connect", () => {
      ...
      socket.on("custom-event", (topic, message) => {
        ...
        if (topic === "HB") {
          ...
          if (message !== null) setPicture(message["key"]);
        } else if (topic === "capture2") {
          if (message !== null) setPicture2(message["key"]);
        } else if (topic === "Processed1") {
          if (message !== null) setPicture(message["key"]);
        } else if (topic === "Processed2") {
          if (message !== null) setPicture2(message["key"]);
                    ...
                    <Card>
                      ...
                      <CardBody>
                        ...
                        >
                          ...
                          >
                            <Marker
                              position={{ lat: 25.0760224, lng: 55.2274879 }}
                            />
                            <Marker
                              position={{ lat: 24.3870994, lng: 54.2289486 }}
                            />
                          </Map>
                        </div>
                      </CardBody>
