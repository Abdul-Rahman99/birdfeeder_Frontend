...
const ManageUsersTypes = () => {
  ...
  const getFeedDevices = () => {
    axios
      ...
      .then((res) => {
        if (res && res.status === true) setFeedDevices(res.data);
      })
  ...
  const saveInfo = () => {
    axios
      .post(api.API_URL + "/api/addUserType", { isNew, id, title })
      .then((res) => {
        if (res && res.status === true) {
          tog_backdrop();
          updateData();
          toast(`User Type ${isNew ? "Added" : "Updated"} Successfully`, {
            position: "top-right",
  ...
  const updateData = () => {
    axios
      .get(api.API_URL + "/api/getUserTypes")
      .then((res) => {
  ...
  const deleteUserType = async (val) => {
    if (window.confirm("Are you sure you wish to delete?")) {
      axios
        .delete(api.API_URL + "/api/deleteUserType/" + val)
        .then((res) => {
          if (res && res.status === true) {
  ...
  const updateUserTypeStatus = (id, is_enabled) => {
    axios
      .post(api.API_URL + "/api/updateUserTypeStatus", {
        id,
        status: is_enabled,
      })
      .then((res) => {
